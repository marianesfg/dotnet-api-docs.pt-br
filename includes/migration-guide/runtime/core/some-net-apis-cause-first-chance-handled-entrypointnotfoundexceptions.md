### <a name="some-net-apis-cause-first-chance-handled-entrypointnotfoundexceptions"></a>Algumas APIs .NET causa primeira instância (tratado) EntryPointNotFoundExceptions
